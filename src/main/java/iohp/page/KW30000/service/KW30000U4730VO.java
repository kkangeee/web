...
public class KW30000U4730VO extends LoginVO {
	...
	public KW30000U4730VO() {
	}
	
	public KW30000U4730VO(String bzRgstNo, int seq, int rnum, String riskEvalTp, String restrNm, String rgstDd,
	...
	public String toString() {
		return "KW30000U4730VO [bzRgstNo=" + bzRgstNo + ", seq=" + seq + ", rnum=" + rnum + ", riskEvalTp=" + riskEvalTp
