	...
	<div class="inner">
		<!-- #content section////////////////////////////// -->
			...
			<section id="content">
				...
				<form id="boardForm" action="${pageContext.request.contextPath}/page/KW60000/KW60000U5100update" method="POST" encType="multipart/form-data">
				...
				<div class="button-group bottom">
					...
					<button type="button" class="secondary"
						onclick="location.href='/page/KW60000/KW60000U5100view.do?contentId=${resultView1.contentId}'">취소</button>
				</div>
			</section>
			<!-- //.board-view -->
		<!-- //////////////////////////////#content section -->
