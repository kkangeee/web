...
<div id="location" class="">
	<ul>
		...
		<li>
			...
			<button
				onclick="$(this).toggleClass('active').next().slideToggle();">관련정보</button>
...
<div id="container">
	...
	<!-- .inner -->
	<div class="inner">
		<form action="/page/KW60000/KW60000U5100write" id="boardForm" method="POST" encType="multipart/form-data">
		<!-- #content section////////////////////////////// -->
		<section id="content">
			<!-- .board-view -->
			...
			<div class="button-group bottom">
				...
				<button type="button" class="secondary"
					onclick="location.href='/page/KW60000/KW60000U5100.do'">취소</button>
			</div>
		</section>
		<!-- //////////////////////////////#content section -->
	</form>	
