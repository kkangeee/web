...
<div id="location" class="">
	<ul>
		...
		<li>
			<button onclick="$(this).toggleClass('active').next().slideToggle();">사업장</button>
			<ul class="dropdown-list clear-able">
			...
			<div class="con_area">
				...
				<div id="ninfo" class="tab_wrap mt20">
					<ul class="tab_base N2">
						<li class="On"><a href="/page/KW30000/KW30000U5110.do"
							target="blank"><span>사업장</span></a></li>
						<li><a href="/page/KW30000/KW30000U5120.do"><span>개인</span></a></li>
					</ul>
				</div>
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U5110selectList", //서비스 주소 
				...
				success : function(res) {
					...
					for (var i = 0; i < list.length; i++) {
						...
						data += '<td class="eduYear">' + list[i].eduYear + '</td>';
						...
						data += '<td class="cmpltnPplCnt">' + list[i].cmpltnPplCnt+ '</td>';
						data += '<td class="cmpltnYn">' + list[i].cmpltnYn+ '</td>';
						data += '</tr>';
					}
