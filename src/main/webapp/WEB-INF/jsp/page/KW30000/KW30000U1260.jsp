         ...
         <!-- ▼ 정보입력 영역 -->
				<div class="tab_wrap mt20">
					<ul class="tab_base N6">
						...
						<li class="On"><a href="/page/KW30000/KW30000U1260.do"><span>예방관리프로그램</span></a></li>
					</ul>
				</div>  
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U1260selectList", //서비스 주소 
				...
				success : function(res) {
					...
					for (var i = 0; i < list.length; i++) {
						...
						data += '<td><button type="submit" id="search" class="btn_His2">작성</button></td>';
						data += '</tr>';
					}
					} else {
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U1260delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	for (i = 0; i < $("input[name=agree1]:checked").length; i++) {
		...
		html += '<td><button type="submit" id="search" class="btn_His2">작성</button></td>';
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U1260save.do", param);
			 getPage();
	     }
	});
