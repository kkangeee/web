...
<!-- #location -->
    ...
    <div id="container">
        ...
        <div class="con_section ">
            <h2 class="con_sectionTit">작업환경관리 / <span class="subtit">위험성 평가 > 화학물질위험성평가 결과 관리 > 결과보기</span></h2>            
        </div>
	...
	$.ajax({
				...
				success : function(res) {
					...
					for (var i = 0; i < list.length; i++) {
						...
						data += '<td class="dtlWrkNm">' + list[i].dtlWrkNm + '</td>';
						data += '<td class="dngrClss">' + list[i].dngrClss + '</td>';
						data += '<td class="dngrOcurSttnRslt">' + list[i].dngrOcurSttnRslt + '</td>';
						data += '<td class="crntSftyHlthActn">' + list[i].crntSftyHlthActn + '</td>';
						data += '<td class="crntRisk">' + list[i].crntRisk + '</td>';
						data += '<td class="decrsActn">' + list[i].decrsActn + '</td>';
						data += '<td class="mprvAftRisk">' + list[i].mprvAftRisk + '</td>';
						data += '<td class="mprvSchDd">' + list[i].mprvSchDd + '</td>';
						data += '<td class="mprvCmpltDd">' + list[i].mprvCmpltDd + '</td>';
						data += '<td class="mprvChrgPrsn">' + list[i].mprvChrgPrsn + '</td>';
						data += '</tr>';
					}
					} else {
						data += "<tr>";
