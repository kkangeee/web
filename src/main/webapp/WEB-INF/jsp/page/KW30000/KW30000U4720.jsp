    ...
    <div id="container">
        ...
        <div class="tab_wrap mt20">
            <ul class="tab_base N3">
              ...
              <li class="On"><a href="/page/KW30000/KW30000U4720.do"><span>위험성평가 결과 관리</span></a></li>
              <li><a href="/page/KW30000/KW30000U4730.do"><span>화학물질위험성평가 결과 관리</span></a></li>
            </ul>
        </div>
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U4720selectList", //서비스 주소 
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U4720delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U4720save.do", param);
			 getPage();
	     }
	});
