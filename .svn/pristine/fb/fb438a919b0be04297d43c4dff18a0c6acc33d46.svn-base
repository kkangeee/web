	...
	<div class="inner">
		...
		<section id="content">
			...
			<div class="con_section ">
		            <h2 class="con_sectionTit" style="margin-bottom:10px;"><span class="subtit">관련정보</span></h2> 
		    </div>
			<!--타이틀 영역 -->
			...
			<div class="button-group bottom">
				<button type="button" class="secondary" onclick="location.href='/page/KW60000/KW60000U5100.do'">목록</button>
			<c:if test="${sessionScope.mbrId eq 'admin'}">
				<button class="primary" type="submit" onclick="location.href='/page/KW60000/KW60000U5100updateForm/${resultView1.contentId}'">수정</button>
...
<script>
	...
	$(document).on('click', '#btn_delete', function(e) {
			if (confirm("정말 삭제하시겠습니까 ?") == true) {
				var url = "/page/KW60000/KW60000U5100delete/"+${resultView1.contentId};
				location.href = url;
			} else {
				return;
			}
	...
	//이전페이지
	function fn_prev() {	
			var url = "<c:url value='/page/KW60000/KW60000U5100view.do'/>?contentId=" + ${resultView1.preContentId};
			location.href = url;
	}
	//다음페이지
	function fn_next() {
			var url = "<c:url value='/page/KW60000/KW60000U5100view.do'/>?contentId=" + ${resultView1.nextContentId};
			location.href = url;
	}
