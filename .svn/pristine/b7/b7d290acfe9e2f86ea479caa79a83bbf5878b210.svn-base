       ...
       <!-- ▼ 정보입력 영역 -->
				<div class="tab_wrap mt20">
					...
					<ul class="tab_base tab_base_sub N2">
						<li><a href="/page/KW30000/KW30000U1230.do"><span>정기안전보건교육</span></a></li>
						<li class="On"><a href="/page/KW30000/KW30000U1230_1.do"><span>기타 교육</span></a></li>
					</ul>
				</div> 
...
function getPage(page) {
	...
	var num = 1; 	
	$.ajax({
				url : "/page/KW30000/KW30000U1230_1selectList", //서비스 주소 
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U1230_1delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	for (i = 0; i < $("input[name=agree1]:checked").length; i++) {
		...
		html += '<td class="tp"><input type="text" value="'+$target.find('.tp').text()+'"></td>';
		html += '<td class="prid"><input type="text" value="'+$target.find('.prid').text()+'"></td>';
		html += '<td class="ttl"><input style="width: 400px" type="text" value="'+$target.find('.ttl').text()+'"></td>';
		html += '<td class="plnDtl"><input style="width: 250px" type="text" value="'+$target.find('.plnDtl').text()+'"></td>';
	...
	$("#insertBtn").on("click",function() {
		...
		html += '<td class="tp"><input type="text"></td>';
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U1230_1save.do", param);
			 getPage();
	     }
	});
