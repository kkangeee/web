    ...
    <div id="container">
        ...
        <div class="tab_wrap mt20">
            <ul class="tab_base N2">
              <li><a href="/page/KW30000/KW30000U1310.do"><span>안전보건관리규정관리</span></a></li>
              <li class="On"><a href="/page/KW30000/KW30000U1320.do"><span>취업규칙관리</span></a></li>
            </ul>
        </div>    
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U1320selectList", //서비스 주소 
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U1320delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U1320save.do", param);
			 getPage();
	     }
