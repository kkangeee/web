...
@Controller
public class KW30000U1220_2Controller {
	@Resource(name = "KW30000U1220_2Service")
	private KW30000U1220_2Service kw30000u1220_2Service;
	/*
	@RequestMapping("/KW30000U1220_2.do")
	public String KW30000U1220_2pageList(@ModelAttribute("kw30000_1200vo") kw30000_1200vo kw30000_1200vo, Model model,
			HttpSession session, HttpServletRequest request) throws Exception {
		List<kw30000_1200vo> resultList1 = kw30000u1220_2Service.KW30000U1220_2pageList(kw30000_1200vo);

		model.addAttribute("resultList1", resultList1);
		System.out.println("controller에서 resultList1의 값" + resultList1);
		return "page/KW30000/KW30000U1220_2";
	}
	*/
	...
	/* Ajax 조회 */
	@ResponseBody
	@RequestMapping(value = "/KW30000U1220_2selectList", produces = "application/json")
	public ResponseEntity<HashMap<String, Object>> KW30000U1220_2List(
			//페이징처리 
		...
		if(popBzRgstNo == null) {
			...
			int listCnt = kw30000u1220_2Service.KW30000U1220_2selectCnt(search);
		...
		// 게시글 화면 출력
		result.put("resultList", kw30000u1220_2Service.KW30000U1220_2select(search));
	...
	/* Ajax 삭제 */
	@ResponseBody
	@RequestMapping(value = "/KW30000U1220_2delete.do", method = { RequestMethod.GET, RequestMethod.POST })
	public void KW30000U1220_2delete(@ModelAttribute("kw30000_1200vo") KW30000_1200VO kw30000_1200vo, HttpServletRequest request, HttpSession session) throws Exception {
	    ...
	    for(int i = 0; i< jsonArray.length();i++) {
	    	 ...
	    	 cnt += kw30000u1220_2Service.KW30000U1220_2delete(kw30000_1200vo);
	    }
	...
	/* Ajax 추가 & 저장 */
	  @ResponseBody
	  @RequestMapping(value = "/KW30000U1220_2save.do", method = {RequestMethod.GET, RequestMethod.POST}) 
	  public void KW30000U1110save(@ModelAttribute("kw30000_1200vo") KW30000_1200VO kw30000_1200vo, Model model, HttpServletRequest request, HttpSession session) throws Exception{
	     ...
	     for(int i = 0; i< jsonArray.length();i++) {
	    	 ...
	    	 kw30000_1200vo.setPlnMidClss("노사협의체");   
			 ...
			 if (!jsonObj.has("seq")) {
				 int insertNum = kw30000u1220_2Service.KW30000U1220_2insertSave(kw30000_1200vo);
				
			 }else {
				 kw30000_1200vo.setSeq(Integer.parseInt(jsonObj.get("seq").toString()));
				 int updateNum = kw30000u1220_2Service.KW30000U1220_2updateSave(kw30000_1200vo);
			 }
	     }
