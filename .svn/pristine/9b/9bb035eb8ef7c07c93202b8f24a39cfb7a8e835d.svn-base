        	...
        	<!-- ▼ 정보입력 영역 -->
				<div class="tab_wrap mt20">
					...
					<ul class="tab_base tab_base_sub N3">
						...
						<li class="On"><a href="/page/KW30000/KW30000U1220_2.do"><span>노사협의체</span></a></li>
					</ul>
				</div> 
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U1220_2selectList", //서비스 주소 
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U1220_2delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U1220_2save.do", param);
			 getPage();
	     }
	});
