...
<!-- <div id="location" class="">
	<ul>
		...
		<li>
			<button onclick="$(this).toggleClass('active').next().slideToggle();">산업안전보건위원회조직도</button>
			<ul class="dropdown-list clear-able">
			...
			<div class="con_area">
				...
				<div class="tab_wrap mt20">
					<ul class="tab_base N7">
						...
						<li class="On"><a href="/page/KW30000/KW30000U1140.do"><span>산업안전보건위원회조직도</span></a></li>
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U1140selectList", //서비스 주소 
...
$("#deleteBtn").on("click",function(){
	...
	var param = {
	 ...
	 if (confirm("삭제하시겠습니까?")) {
		common.ajaxaa("/page/KW30000/KW30000U1140delete.do", param);
		 getPage();
     }
});
...
$("#updateBtn").on("click", function() {
	...
	$("#insertBtn").on("click",function() {
		...
		html += '<td class="fonNo"><input type="text"></td>';
	...
	$("#saveBtn").on("click", function() {
		...
		if (confirm("저장하시겠습니까?")) {
			common.ajaxaa("/page/KW30000/KW30000U1140save.do", param);
			 getPage();
	     }
	});
