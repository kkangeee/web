    ...
    <div class="inner">
		...
		<section id="content">
			...
			<div class="con_section ">
				<h2 class="con_sectionTit"><span class="subtit">관련서식</span></h2>
			</div>
			<!--타이틀 영역 -->
			...
			<div class="button-group bottom">
				<c:if test="${sessionScope.mbrId eq 'admin'}">
						<button type="button" class="primary" onclick="location.href='/page/KW60000/KW60000U4100_write.do'">글쓰기</button>
				</c:if>
			</div>	
			<!-- 하단box -->
			<div class="km500">
...
<script type="text/javascript">
	...
	function getPage(page) {
		...
		$.ajax({
					url : "/page/KW60000/kw60000U4100List.do", //서비스 주소 
	...
	function fn_view(contentId){
		  ...
		  var url = "<c:url value='/page/KW60000/KW60000U4100view.do'/>?contentId=" + contentId;
		   form.action = url;    
		   form.submit(); 
	}
