...
<!-- #location -->
    ...
    <div id="container">
        ...
        <div class="tab_wrap mt20">
            <ul class="tab_base N3">
              <li class="On"><a href="/page/KW30000/KW30000U2310.do"><span>건강진단결과 통계</span></a></li>
  ...
  <section id="content">
    <div class="button-group top">
      <%-- <!-- ▼ 사업자명 사업자등록번호 검색 영역 -->
      <c:if test="${sessionScope.authUser.roleAuthId eq 'admin'}">
    ...
    <table class="board-list">
      ...
      <thead>
        <tr>
          ...
          <th>
            <select class="select_bd_tit" name="searchType">
                <option value="">업무수행<br>적합여부</option>
            </select>
          </th>
        </tr>
...
function getPage(page) {
	...
	$.ajax({
				url : "/page/KW30000/KW30000U2310selectList", //서비스 주소 
				...
				success : function(res) {
					...
					for (var i = 0; i < list.length; i++) {
						...
						data += '<td class="bldPres">' + list[i].bldPres + '</td>';
						data += '<td class="wstCrcm">' + list[i].wstCrcm + '</td>';
						data += '<td class="bldSgar">' + list[i].bldSgar + '</td>';
						...
						data += '<td class="jdgTp">' + list[i].jdgTp + '</td>';
