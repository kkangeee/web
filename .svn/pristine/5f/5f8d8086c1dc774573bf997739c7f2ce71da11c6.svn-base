...
@Controller
public class KW30000U4620Controller {
	@Resource(name = "KW30000U4620Service")
	private KW30000U4620Service kw30000u4620Service;
	/*
	...
	*/
	...
	@RequestMapping("/KW30000U4620.do")
	public String KW30000U4620pageList(@ModelAttribute("kw30000u4610vo") KW30000U4610VO kw30000u4610vo, Model model,
									   HttpSession session, HttpServletRequest request) throws Exception {
	
		model.addAttribute("act", "KW30000U4610");
		return "page/KW30000/KW30000U4620";
	}
	
	/* Ajax 조회 */
	@ResponseBody
	@RequestMapping(value = "/KW30000U4620selectList", produces = "application/json")
	public ResponseEntity<HashMap<String, Object>> KW30000U4620List(
			//페이징처리 
		...
		if(popBzRgstNo == null) {
			...
			int listCnt = kw30000u4620Service.KW30000U4620selectCnt(search);
		...
		// 게시글 화면 출력
		result.put("resultList", kw30000u4620Service.KW30000U4620select(search));
	...
	/* Ajax 삭제 */
	@ResponseBody
	@RequestMapping(value = "/KW30000U4620delete.do", method = { RequestMethod.GET, RequestMethod.POST })
	public void KW30000U4620delete(@ModelAttribute("kw30000u4610vo") KW30000U4610VO kw30000u4610vo, HttpServletRequest request, HttpSession session) throws Exception {
	    ...
	    //	 kw30000u4610vo.setTableNm("TB_KW50_SFTY_HLTH_ORG_CMPS");
	    	 ...
	    	 cnt += kw30000u4620Service.KW30000U4620delete(kw30000u4610vo);
	    }
	...
	/* Ajax 추가 & 저장 */
	  @ResponseBody
	  @RequestMapping(value = "/KW30000U4620save.do", method = {RequestMethod.GET, RequestMethod.POST}) 
	  public void KW30000U4620save(@ModelAttribute("kw30000u4610vo") KW30000U4610VO kw30000u4610vo, Model model, HttpServletRequest request, HttpSession session) throws Exception{
		...
		//세션값 가져오기
	     ...
	     for(int i = 0; i< jsonArray.length();i++) {
	    	 ...
	    	 // [{ aa : nn } 
				  ...
				  kw30000u4610vo.setMprvNeedYn((String)jsonObj.get("mprvNeedYn"));
				  kw30000u4610vo.setMprvActnYn((String)jsonObj.get("mprvActnYn"));
			 ...
			 if (!jsonObj.has("seq")) {
				 ...
				 int insertNum = kw30000u4620Service.KW30000U4620insertSave(kw30000u4610vo);
				
			 }else {
				 kw30000u4610vo.setSeq(Integer.parseInt(jsonObj.get("seq").toString()));
				 int updateNum = kw30000u4620Service.KW30000U4620updateSave(kw30000u4610vo);
			 }
	     }
