...
public class CustomerVO extends LoginVO {
	...
	private static final long serialVersionUID = -6145254801101529317L;
	...
	/* 팝업관리 */
	private int popupId; 	/* 팝업ID */
	private String publicYn; 	/* 공개여부 */
	private String startDate; 	/* 시작일자 */
	private String endDate; 	/* 종료일자 */
	private String popupImg; 	/* 팝업이미지 */
	private String link; 	/* 링크 */
	private String target; 	/* 출력방법 */
	
	private String opt01; 	/* TOP */
	private String opt02; 	/* LEFT */
	private String opt03; 	/* WIDTH */
	private String opt04; 	/* HEIGHT */
	private String opt05; 	/* ADMIN_YN */
	private String opt06; 	/* COMM000_YN */
	private String opt07; 	/* COMM030_YN */
	...
	public String getOpt06() {
		return opt06;
	}
	public void setOpt06(String opt06) {
		this.opt06 = opt06;
	}
	public String getOpt07() {
		return opt07;
	}
	...
	public CustomerVO(int rnum, int contentId, int parentId, int boardId, String title, String secretYn,
			...
			String rplysecretPw2, String rplyParentId, int rplyCnt, String boardFile, String boardFileName,
			MultipartFile uploadFile, String boardImgName, String videoUrl, int popupId, String publicYn,
			String startDate, String endDate, String popupImg, String link, String target, String opt01, String opt02,
			String opt03, String opt04, String opt05, String opt06, String opt07) {
		this.rnum = rnum;
		this.contentId = contentId;
		this.parentId = parentId;
		this.boardId = boardId;
	...
	public String toString() {
		return "CustomerVO [rnum=" + rnum + ", contentId=" + contentId + ", parentId=" + parentId + ", boardId="
				...
				+ rplyParentId + ", rplyCnt=" + rplyCnt + ", boardFile=" + boardFile + ", boardFileName="
				+ boardFileName + ", uploadFile=" + uploadFile + ", boardImgName=" + boardImgName + ", videoUrl="
				+ videoUrl + ", popupId=" + popupId + ", publicYn=" + publicYn + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", popupImg=" + popupImg + ", link=" + link + ", target=" + target
				+ ", opt01=" + opt01 + ", opt02=" + opt02 + ", opt03=" + opt03 + ", opt04=" + opt04 + ", opt05=" + opt05
				+ ", opt06=" + opt06 + ", opt07=" + opt07 + "]";
	}
