	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/smarteditorMultiImageUpload.do',	//샘플 URL입니다.
 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/smarteditor/sample/pohoto_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
