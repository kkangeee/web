...
public class KW60000VO extends LoginVO {
	
	private static final long serialVersionUID = -1764299500854894526L;
	/* 게시판 공통 */
	...
	public KW60000VO(int rNum, int contentId, int parentId, int boardId, String title, String secretYn, String secretPw,
			String topYn, String delYn, String cnt, String displayUser, String regDt, String content, String cate,
			int nextContentId, String nextTitle, int preContentId, String preTitle, String agreement, String answerYn,
			String userPhone, String email, String email1, String email2, String nameSecretYn, int rplyId,
			int rplyContentId, String rplyRegDt, String rplyUser, String rplySecretPw, String rplyContent,
	...
	public String toString() {
		return "KW60000VO [rNum=" + rNum + ", contentId=" + contentId + ", parentId=" + parentId + ", boardId="
