	...
	<div class="inner">
		<!-- #content section////////////////////////////// -->
			...
			<section id="content">
				...
				<!-- .board-view -->
				<form id="boardForm" action="${pageContext.request.contextPath}/page/KW20000/KW20000U1500Update" method="POST" encType="multipart/form-data">
				...
				<div class="button-group bottom">
					...
					<button type="button" class="secondary" onclick="location.href='/page/KW20000/KW20000U1500View?contentId=${resultView1.contentId}'">취소</button>
				</div>
			</section>
			<!-- //.board-view -->
		<!-- //////////////////////////////#content section -->
