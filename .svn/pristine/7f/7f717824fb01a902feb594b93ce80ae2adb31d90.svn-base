...
<div id="location" class="">
	<ul>
		...
		<li>
			<button onclick="$(this).toggleClass('active').next().slideToggle();">예방관리프로그램</button>
			<ul class="dropdown-list clear-able">
				<li><a href="/page/KW30000/KW30000U3100.do">예방관리프로그램</a></li>
			</ul>
		</li>
		<li>
			<button onclick="$(this).toggleClass('active').next().slideToggle();">밀폐공간보건작업프로그램</button>
			<ul class="dropdown-list clear-able">
				<li><a href="/page/KW30000/KW30000U3100.do">밀폐공간보건작업프로그램</a></li>
				<li><a href="/page/KW30000/KW30000U3210.do">청력보존프로그램</a></li>
				<li><a href="/page/KW30000/KW30000U3300.do">호흡기보존프로그램</a></li>
			</ul>
		</li>
	</ul>
</div>
<!-- #location -->
    ...
    <div id="container">
        ...
        <div class="con_section ">
            <h2 class="con_sectionTit">예방관리프로그램 / <span class="subtit">밀폐공간보건작업 프로그램</span></h2>            
        </div>
  ...
  <section id="content">
    ...
    <!-- 테이블01 -->   
    <!-- 타기관 결과 업로드 관리 기능 구현, OCR로 인식하여 결과값이 자동 입력되어야 함 -->
    <table class="board-list">
      ...
      <tbody>
        <tr>          
          ...
          <td></td>
          <td></td>
          <td><button type="submit" id="search" class="btn_His2">결과보기</button></td>
          <td><button type="submit" id="search" class="btn_His2">업로드</button></td>
        </tr>
